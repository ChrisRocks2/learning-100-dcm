...
describe('higher order function', () => {
    it('a simple example', () => {
        ...
        expect(formatName('Ben', 'Solo', (n) => '%%%' + n.toUpperCase())).toBe('%%%SOLO, BEN');
    ...
    describe('tag maker', () => {
        ...
        it('as a higher-order fucntion', () => {
            ...
            //tagmaker rtns function and stuff executes the rtnd function
